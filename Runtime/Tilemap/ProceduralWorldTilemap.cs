...
namespace Jolybob.ProceduralWorld.Tilemap
{
    ...
    public sealed class ProceduralWorldTilemap : MonoBehaviour
    {
        ...
        private void BuildRuntimeTiles()
        {
            ...
            {
                // Solid is the default topology state for ordinary terrain cells, not a visual
                // override. Leaving it unmapped lets the terrain catalog provide the actual tile.
